  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="https://images.pexels.com/photos/5752242/pexels-photo-5752242.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            {t.proceduresPage.hero.subtitle}
          </motion.p>
          ...
          >
            ...
            >
              ...
              <span>{t.proceduresPage.hero.cta}</span>
              </motion.button>
            </Link>
